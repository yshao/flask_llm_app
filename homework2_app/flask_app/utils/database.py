...
class database:
    ...
    def __init__(self, purge=False):
        ...
        self.tables = ['institutions', 'positions', 'experiences', 'skills', 'users', 'documents', 'llm_roles', 'benchmark_test_cases', 'benchmark_results']
    ...
    def insertRows(self, table='table', columns=['x','y'], parameters=[['v11','v12'],['v21','v22']]):
        ...
        if EMBEDDING_AVAILABLE:
            ...
            # Note: 'documents' table embeddings are handled by WebCrawlerAgent
            # We don't auto-generate embeddings here since the crawler manages them
